...
namespace Mexican_Grill.Tacos.Tacos{
    public class PlatedSoftBeefGuac : CustomItemGroup<ItemGroupView>
    {
        public override string UniqueNameID => "PlateSoftBeefGuac";
        ...
        public override List<ItemGroup.ItemSet> Sets => new()
        {
            new()
            {
                Items = new()
                {
                    ...
                    GDOUtils.GetCastedGDO<Item, SoftBeefGuac>()
                },
                Max = 2,
                Min = 2,
            }
        };
        public override GameObject Prefab => GetPrefab("Plated Soft Beef Guac Taco");
