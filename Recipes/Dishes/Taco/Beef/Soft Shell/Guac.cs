...
namespace Mexican_Grill.Tacos.Tacos{
    public class SoftBeefGuac : CustomItemGroup<ItemGroupView>
    {
        public override string UniqueNameID => "SoftBeefGuac";
        ...
        public override GameObject Prefab => GetPrefab("Soft Beef Guac Taco");
